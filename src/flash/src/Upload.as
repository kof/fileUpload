...
public class Upload extends Sprite {
    ...
    private function init(e:Event = null):void {
        ...
        ExternalInterface.addCallback('flashUploadSendFile', this.uploadFile);
        ExternalInterface.addCallback('flashUploadClearQueue', this.clearFiles);
        ExternalInterface.addCallback('flashUploadRemoveFile', this.removeFile);
        ExternalInterface.addCallback('flashUploadCancelFileUpload', this.cancelFileUpload);
        this.dispatch('flashinit');
    }
    ...
    private function stageEvent(e:Event):void {
        this.dispatch(e.type.toLowerCase());
    }
    ...
    */
    ...
    private function selectEvent(e:Event):void {
        ...
        this.dispatch("change", selectedFiles);
    }
    ...
    private function stageClickEvent(e:Event):void {
        ...
        try {
            ...
            this.dispatch("selecterror", ex.message);
        }
    }
    
    /**
     * Call the callback function via external interface
     *
     * @param type Name of event to fire.
     * @param obj Object with optional data.
     */
    private function dispatch(type:String, data:Object = null):void {
        ExternalInterface.call((<![CDATA[
            function(callbackName, data) {
                if (typeof window[callbackName] != 'function') {
                    throw ("No flashUploader callback defined with name '" + callbackName +"'");            
                }
